...
type
  Tdmdados = class(TDataModule)
    ...
    tbLibCreditoPai: TStringField;
    tbLibCreditoMae: TStringField;
    tbDepende: TTable;
    ...
    tbRecVenCliCodDoc: TStringField;
    tbRecVenCliCodHist: TStringField;
    ...
    tbOutros: TTable;
    tbOutrosCodProd: TStringField;
    tbOutrosQuant: TSmallintField;
    tbOutrosVlUnit: TCurrencyField;
    tbOutroslkDescrProd: TStringField;
    tbOutrosVlTotal: TCurrencyField;
    tbComandaData: TDateField;
    tbComandaCodCliente: TIntegerField;
    tbComandaBalconista: TIntegerField;
    tbComandaAE: TFloatField;
    tbComandaBE: TFloatField;
    tbComandaCE: TFloatField;
    tbComandaDE: TFloatField;
    tbComandaEE: TFloatField;
    tbComandaFE: TFloatField;
    tbComandaGE: TFloatField;
    tbComandaHE: TFloatField;
    tbComandaIE: TFloatField;
    tbComandaJE: TFloatField;
    tbComandaKE: TFloatField;
    tbComandaLE: TFloatField;
    tbComandaME: TFloatField;
    tbComandaNE: TFloatField;
    tbComandaOE: TFloatField;
    tbComandaPE: TFloatField;
    tbComandaQE: TFloatField;
    tbComandaRE: TFloatField;
    tbComandaSE: TFloatField;
    tbComandaTE: TFloatField;
    tbComandaUE: TFloatField;
    tbComandaVE: TFloatField;
    tbComandaXE: TFloatField;
    tbComandaZE: TFloatField;
    tbComandaAD: TFloatField;
    tbComandaBD: TFloatField;
    tbComandaCD: TFloatField;
    tbComandaDD: TFloatField;
    tbComandaED: TFloatField;
    tbComandaFD: TFloatField;
    tbComandaGD: TFloatField;
    tbComandaHD: TFloatField;
    tbComandaID: TFloatField;
    tbComandaJD: TFloatField;
    tbComandaKD: TFloatField;
    tbComandaLD: TFloatField;
    tbComandaMD: TFloatField;
    tbComandaND: TFloatField;
    tbComandaOD: TFloatField;
    tbComandaPD: TFloatField;
    tbComandaQD: TFloatField;
    tbComandaRD: TFloatField;
    tbComandaSD: TFloatField;
    tbComandaTD: TFloatField;
    tbComandaUD: TFloatField;
    tbComandaVD: TFloatField;
    tbComandaXD: TFloatField;
    tbComandaZD: TFloatField;
    tbComandaStatus: TStringField;
    tbComandalkNomeCli: TStringField;
    ...
    tbComandaZDValor: TCurrencyField;
    tbCoEstoque: TTable;
    dsCoEstoque: TDataSource;
    tbCoEstoqueCodMerc: TStringField;
    tbCoEstoqueDescricao: TStringField;
    tbCoEstoqueCodMarca: TIntegerField;
    tbCoEstoqueCodSubGrupo: TIntegerField;
    tbCoEstoqueQuantidade: TFloatField;
    tbCoEstoqueSigla: TStringField;
    tbCoEstoqueEstoqueMin: TFloatField;
    tbCoEstoqueEstoqueMax: TFloatField;
    tbCoEstoqueUltimaCompra: TDateField;
    tbCoEstoquePrecoCompra: TCurrencyField;
    tbCoEstoqueCodIndex: TIntegerField;
    tbCoEstoqueMargem: TSmallintField;
    tbCoEstoquePrecoVenda: TCurrencyField;
    tbCoEstoqueUltimaVenda: TDateField;
    tbCoEstoqueFoto: TGraphicField;
    tbCoEstoqueComponente: TStringField;
    tbCoEstoquePrSoma: TCurrencyField;
    tbCoEstoqueQtVenda: TSmallintField;
    tbCoEstoquePrecoVendaAt: TCurrencyField;
    tbCoEstoquelkMarca: TStringField;
    tbCoEstoquelkSubGrupo: TStringField;
    tbCoEstoquelkCoGrupo: TIntegerField;
    tbCoEstoquelkGrupo: TStringField;
    tbMovCaixa: TTable;
    tbMovCaixaCodMov: TAutoIncField;
    tbMovCaixaTipoOper: TStringField;
    tbMovCaixaDataMov: TDateField;
    tbMovCaixaCodDoc: TStringField;
    tbMovCaixaDosNumero: TStringField;
    tbMovCaixaValor: TCurrencyField;
    tbMovCaixaCodHist: TStringField;
    ...
    tbOutrosCodCartao: TIntegerField;
    tbComandaNada: TAutoIncField;
    tbCoMarca: TTable;
    dsCoMarca: TDataSource;
    tbCoMarcaCodMarca: TAutoIncField;
    tbCoMarcaMarca: TStringField;
    tbCaixaReforco: TCurrencyField;
    tbCaixaTrocoFim: TCurrencyField;
    tbContaCliente: TTable;
    tbContaClienteConta: TStringField;
    tbContaClienteSaldo: TCurrencyField;
    tbContaClienteUltMov: TDateField;
    tbContaClienteHoraMov: TTimeField;
    tbContaClienteDataCad: TDateField;
    dsContaCliente: TDataSource;
    tbCompEsto: TTable;
    tbCompEstoCodEsto: TIntegerField;
    tbCompEstoCodCom: TIntegerField;
    tbCompEstoFator: TFloatField;
    dsCompEsto: TDataSource;
    tbCompEstolkDescricao: TStringField;
    tbCompEstolkCodProd: TStringField;
    tbEstoPrinc: TTable;
    dsEstoPrinc: TDataSource;
    tbEstoPrincNada: TAutoIncField;
    tbEstoPrincCodMerc: TStringField;
    tbEstoPrincDescricao: TStringField;
    tbEstoPrincCodMarca: TIntegerField;
    tbEstoPrincCodSubGrupo: TIntegerField;
    tbEstoPrincQuantidade: TFloatField;
    tbEstoPrincSigla: TStringField;
    tbEstoPrincEstoqueMin: TFloatField;
    tbEstoPrincEstoqueMax: TFloatField;
    tbEstoPrincUltimaCompra: TDateField;
    tbEstoPrincPrecoCompra: TCurrencyField;
    tbEstoPrincCodIndex: TIntegerField;
    tbEstoPrincMargem: TSmallintField;
    tbEstoPrincPrecoVenda: TCurrencyField;
    tbEstoPrincUltimaVenda: TDateField;
    tbEstoPrincFoto: TGraphicField;
    tbEstoPrincComponente: TStringField;
    tbEstoPrincPrSoma: TCurrencyField;
    tbEstoPrincQtVenda: TSmallintField;
    tbEstoPrincPrecoVendaAt: TCurrencyField;
    tbCaixaTotVista: TFloatField;
    tbCaixaTotSai: TFloatField;
    tbCaixaTotFecha: TFloatField;
    tbConvenioNada: TAutoIncField;
    tbConvenioAdmin: TStringField;
    tbConvenioContato: TStringField;
    tbConvenioTel1: TStringField;
    tbConvenioTel2: TStringField;
    tbConvenioTaxa: TFloatField;
    ...
    procedure tbOutrosCalcFields(DataSet: TDataSet);
    procedure tbComandaAfterDelete(DataSet: TDataSet);
    procedure tbComandaAfterPost(DataSet: TDataSet);
    procedure tbOutrosAfterPost(DataSet: TDataSet);
    procedure tbOutrosAfterDelete(DataSet: TDataSet);
    procedure tbMovCaixaAfterDelete(DataSet: TDataSet);
    procedure tbMovCaixaAfterPost(DataSet: TDataSet);
    procedure tbContaClienteAfterDelete(DataSet: TDataSet);
    procedure tbContaClienteAfterPost(DataSet: TDataSet);
...
procedure Tdmdados.tbOutrosCalcFields(DataSet: TDataSet);
begin
    tbOutrosVlTotal.Value:=tbOutrosQuant.Value * tbOutrosVlUnit.Value;
end;

procedure Tdmdados.tbComandaAfterDelete(DataSet: TDataSet);
begin
  dbisaveChanges(tbComanda.Handle);
end;

procedure Tdmdados.tbComandaAfterPost(DataSet: TDataSet);
begin
  dbisaveChanges(tbComanda.Handle);
end;

procedure Tdmdados.tbOutrosAfterPost(DataSet: TDataSet);
begin
  dbisaveChanges(tbOutros.Handle);
end;

procedure Tdmdados.tbOutrosAfterDelete(DataSet: TDataSet);
begin
  dbisaveChanges(tbOutros.Handle);
end;

procedure Tdmdados.tbMovCaixaAfterDelete(DataSet: TDataSet);
begin
  dbisaveChanges(tbMovCaixa.Handle);
end;

procedure Tdmdados.tbMovCaixaAfterPost(DataSet: TDataSet);
begin
  dbisaveChanges(tbMovCaixa.Handle);
end;

procedure Tdmdados.tbContaClienteAfterDelete(DataSet: TDataSet);
begin
  dbisaveChanges(tbContaCliente.Handle);
end;

procedure Tdmdados.tbContaClienteAfterPost(DataSet: TDataSet);
begin
  dbisaveChanges(tbContaCliente.Handle);
end;

procedure Tdmdados.tbCaixaCalcFields(DataSet: TDataSet);
begin
  tbCaixaTotVista.Value := tbCaixaRDin.Value + tbCaixaRCheque.Value + tbCaixaRValeRefe.Value +
                           tbCaixaRConVale.Value + tbCaixaReforco.Value;
  tbCaixaTotSai.Value   := tbCaixaVales.Value + tbCaixaSaida.Value + tbCaixaPagto.Value +
                           tbCaixaReforco.Value;
  tbCaixaTotFecha.Value := tbCaixaRValeRefe.Value + tbCaixaRConVale.Value + tbCaixaTrocoFim.Value +
                           tbCaixaRCheque.Value;
end;
